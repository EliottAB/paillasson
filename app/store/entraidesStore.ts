...
export interface EntraideCreation {
  category?: string;
  photo?: string;
  description?: string;
  animal?: {
...
interface EntraideCreationStore {
  entraideCreation: EntraideCreation;
...
export const entraideCreationStore = create<EntraideCreationStore>((set) => ({
  entraideCreation: {},
  setCategory: (categ: string) => {
    set(() => ({ entraideCreation: { category: categ }}));
  }
}));
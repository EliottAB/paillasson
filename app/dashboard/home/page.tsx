    ...
    <>
      ...
      <main className="pb-10">
        <article>
          <section>
            { voisinages.length > 0 &&
              <ul className="flex gap-3 px-4 my-3 max-w-[100vw] overflow-auto scroll-hide pt-12 pb-5 mb-6">
                {
          ...
          <section>
            {voisinages.length > 0 && <div className="w-[100vw] h-[2px] bg-gray-200"></div>}
            <h2 className="text-xl font-bold px-4 py-4">Entraides récentes</h2>
            {
              entraides.length < 1 ? (
                <div className="flex flex-col items-center">
                  <Image className="grayscale-[100%] opacity-20" src={'/assets/handshake.png'} alt="Image grisée d'humains parlants" width={200} height={200}/>
                  <p className="text-gray-400 text-sm -mt-3">Aucune entraide récente</p>
                </div>
              )
              :
